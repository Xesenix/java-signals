...
/**
 * Collects connections to allow mass operations on them. The group holds a
 * {@link WeakReference} to a Connection, so if nothing else is holding onto the
 * connection, it'll be garbage collected.
 */
public class ConnectionGroup
{
	...
	/**
	 * Removes a connection from the group while leaving its connected status
	 * unchanged.
	 */
